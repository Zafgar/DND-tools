    ...
    def __init__(self, manager):
        ...
        self.buttons = [
            ...
            Button(cx-bw//2, start_y + (bh+gap)*3, bw, bh, "Hero Creator",
                   ...
                   color=COLORS["player"]),
            Button(cx-bw//2, start_y + (bh+gap)*4, bw, bh, "Combat Audit",
                   lambda: manager.change_state("COMBAT_AUDIT"),
                   color=COLORS["warning"], style="outline"),
            Button(cx-bw//2, start_y + (bh+gap)*5, bw, bh, "Load Scenario",
                   lambda: self._open_load_modal(),
                   color=COLORS["panel_light"], style="outline"),
            Button(cx-bw//2, start_y + (bh+gap)*6, bw, bh, "Import from TaleSpire",
                   lambda: self._import_from_talespire(),
                   color=COLORS["accent_dim"], style="outline"),
            Button(cx-bw//2, start_y + (bh+gap)*7, bw, bh, "Exit",
                   lambda: manager.quit(),
